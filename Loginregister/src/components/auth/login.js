...
import {user Actions} from '../../actions';
    ...
    render(){
        ...
        return(
             ...
             <form name="form">
                 ...
                 <input type="password" id="exampleInputPassword" className="form-control input-shadow" placeholder="Enter The Password" value={this.state.password} 
